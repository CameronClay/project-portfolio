...
//doesnt work with beforeAll because beforeAll runs before beforeEach (beforeEach clears the db)
beforeEach(async () => {
    ...
    //delete user before first test runs as it expects fresh db for each test
