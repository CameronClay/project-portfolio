...
export async function delete_user_by_username(
    username: string,
    password: string
) {
    let response: Response | null = null;
    try {
        response = await fetch(PROD_URL + '/api/private/admin/user', {
            method: 'DELETE',
            headers: {
...
export async function get_users() {
    let response: Response | null = null;
    try {
        response = await fetch(PROD_URL + '/api/private/admin/users', {
            method: 'GET',
            headers: {
...
export async function get_stats() {
    let response: Response | null = null;
    try {
        response = await fetch(PROD_URL + '/api/private/admin/stats', {
            method: 'GET',
            headers: {
                Accept: 'application/json, text/plain, */*',
                'Content-Type': 'application/json',
